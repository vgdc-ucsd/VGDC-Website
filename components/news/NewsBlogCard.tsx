 ...
 * @param post the BlogPostData object containing the data
...
export default function NewsBlogCard({
  ...
  return (
    ...
    >
      {post.coverImage && <div className="flex-shrink-0 bg-gray-950 pb-4 md:w-[26rem] lg:w-[28rem]">
        <Image
          src={post.coverImage}
          width={600}
          height={600}
      ...
      <div className="pl-0">
        ...
        <div className="mt-2 inline-flex items-center">
          ...
          <p className="ml-2 text-base text-white">{post.authors}</p>
          <p className="mx-1">•</p>
