  ...
  return(
    ...
    <section className = {`
      ...
      <div className = "mb-12 lg:mr-24 mx-auto w-fit">
        <h1 className = "text-white text-7xl lg:text-9xl font-extrabold text-center lg:text-left">Our <br/> Mission</h1>
        <div className="flex flex-row items-center w-fit mx-auto lg:mx-0">
      ...
      <p className = "text-base text-text-grey xl:text-lg max-w-[480px] text-center lg:text-left">
